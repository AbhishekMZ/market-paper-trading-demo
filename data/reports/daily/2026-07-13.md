# 📄 Paper Trading Report — 2026-07-13 (mid)
...
## 🚫 Do-not-buy
RELIANCE.NS(49.7), AXISBANK.NS(47.9), ITC.NS(44.8), LT.NS(40.2), TCS.NS(38.0)
...
- ICICIBANK.NS (WATCH, 69.0): Final 69.0/100 -> WATCH [regime NEUTRAL]. Top: trend_following=94, portfolio_fit=80, news_event_risk=65.
- SBIN.NS (NO_ACTION, 59.7): Final 59.7/100 -> NO_ACTION [regime NEUTRAL]. Top: portfolio_fit=80, news_event_risk=65, trend_following=59.
- HDFCBANK.NS (NO_ACTION, 59.5): Final 59.5/100 -> NO_ACTION [regime NEUTRAL]. Top: trend_following=88, portfolio_fit=80, news_event_risk=65. Disagreement: ['trend_following', 'portfolio_fit'] positive vs ['relative_strength'] negative.
- BHARTIARTL.NS (NO_ACTION, 58.3): Final 58.3/100 -> NO_ACTION [regime NEUTRAL]. Top: portfolio_fit=80, trend_following=76, news_event_risk=65. Disagreement: ['trend_following', 'portfolio_fit'] positive vs ['relative_strength'] negative.
...
- RELIANCE.NS (DO_NOT_BUY, 49.7): Final 49.7/100 -> DO_NOT_BUY [regime NEUTRAL]. Top: portfolio_fit=80, news_event_risk=65, volatility_risk=54. Disagreement: ['portfolio_fit'] positive vs ['relative_strength'] negative.
- AXISBANK.NS (DO_NOT_BUY, 47.9): Final 47.9/100 -> DO_NOT_BUY [regime NEUTRAL]. Top: portfolio_fit=80, news_event_risk=65, volatility_risk=57. Disagreement: ['portfolio_fit'] positive vs ['trend_following'] negative.
- ITC.NS (DO_NOT_BUY, 44.8): Final 44.8/100 -> DO_NOT_BUY [regime NEUTRAL]. Top: volatility_risk=66, news_event_risk=65, portfolio_fit=35. Disagreement: ['volatility_risk'] positive vs ['trend_following', 'relative_strength', 'portfolio_fit'] negative.

## 📊 Market-data usage
- Provider: `yfinance` · calls today: 24 · total this month: 312 (no API-key quota)
...
- Share price ₹3931 exceeds per-trade cap ₹2000.
