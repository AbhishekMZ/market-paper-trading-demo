...
## 🚫 Do-not-buy
TCS.NS(42.8), LT.NS(38.4), INFY.NS(33.7)
...
- ICICIBANK.NS (WATCH, 70.8): Final 70.8/100 -> WATCH [regime NEUTRAL]. Top: trend_following=94, portfolio_fit=80, relative_strength=71.
- SBIN.NS (NO_ACTION, 64.6): Final 64.6/100 -> NO_ACTION [regime NEUTRAL]. Top: trend_following=90, portfolio_fit=80, news_event_risk=65.
- HDFCBANK.NS (NO_ACTION, 62.4): Final 62.4/100 -> NO_ACTION [regime NEUTRAL]. Top: trend_following=89, portfolio_fit=80, news_event_risk=65.
- AXISBANK.NS (NO_ACTION, 60.4): Final 60.4/100 -> NO_ACTION [regime NEUTRAL]. Top: trend_following=88, portfolio_fit=80, news_event_risk=65. Disagreement: ['trend_following', 'portfolio_fit'] positive vs ['relative_strength'] negative.
- BHARTIARTL.NS (NO_ACTION, 56.0): Final 56.0/100 -> NO_ACTION [regime NEUTRAL]. Top: portfolio_fit=80, trend_following=66, news_event_risk=65. Disagreement: ['trend_following', 'portfolio_fit'] positive vs ['relative_strength'] negative.
- ITC.NS (HOLD, 54.1): Final 54.1/100 -> HOLD [regime NEUTRAL]. Top: volatility_risk=66, trend_following=65, news_event_risk=65. Disagreement: ['trend_following', 'volatility_risk'] positive vs ['relative_strength', 'portfolio_fit'] negative.
- RELIANCE.NS (NO_ACTION, 50.0): Final 50.0/100 -> NO_ACTION [regime NEUTRAL]. Top: portfolio_fit=80, news_event_risk=65, volatility_risk=57. Disagreement: ['portfolio_fit'] positive vs ['relative_strength'] negative.
...
## 📊 Market-data usage
- Provider: `yfinance` · calls today: 12 · total this month: 48 (no API-key quota)

## 🧪 Data-quality warnings
- Already held — adding would require averaging (blocked) and reduces diversification.
- Share price ₹2063 exceeds per-trade cap ₹2000.
- Share price ₹4025 exceeds per-trade cap ₹2000.
